...
import { Group, Header, Image, Text, UnstyledButton } from '@mantine/core';
...
const TitleBar = () => {
  ...
  return (
    <Header height={'2rem'} sx={{ width: '100vw', display: 'flex', alignItems: 'center', zIndex: 50, backgroundColor: '#1D1D20' }} className="title-bar-drag">
      <Group noWrap align='center' position='center' ml={8} spacing='xs'>
        {/* Logo */}
        <Image width={20} height={20} src='../assets/logo.svg' />
        <Text size='sm' sx={{ color: 'white' }}> Antho </Text>
      </Group>
